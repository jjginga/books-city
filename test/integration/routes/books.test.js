...
//should return 404 if no book with the given id is found
//should return a book if valid id is passed

//POST
//should return 401 if client is not logged in
//should return 400 if title is under 3 characters
//should return 400 if title is over 50 characters
//should return 400 if authorId is not provided
//should return 400 if categoryId is not provided
//should return 400 if publisherId is not provided
//should return 400 if stock is not provided
//should return 400 if no author with given Id exists
//should return 400 if no category with given Id exists
//should return 400 if no publisher with given Id exists
//should save book if is valid
//should return book if is valid
...
//should return 400 if no category with given Id exists
//should return 400 if no publisher with given Id exists
//should return 404 if no book with the given Id was found
//should save book if is valid
//should return book if is valid
...
//should return 404 if invalid id is passed
//should return 404 if no book with the given Id was found
//should delete book if is valid
//should return book if is valid
